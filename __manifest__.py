...

{
    ...
    'assets': { 'point_of_sale._assets_pos': [
            "sh_pos_product_variant/static/src/overrides/Components/ProductConfiguratorPopup.js",
            "sh_pos_product_variant/static/src/overrides/Components/ProductConfiguratorPopup.xml",
